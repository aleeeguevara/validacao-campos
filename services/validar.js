...
const retornarMensagemDeErro = (tipo, validity) => {
    ...
    const mensagensDeErro = {
        ...
        senha: {
            ...
            tooShort: "A senha deve conter no mínimo 4 caracteres",
        },
        dataNascimento: {
            valueMissing: "A data de nascimento é necessária",
            rangeUnderflow: "A data mínima é 01/01/1900",
            customError: "A idade mínima é de 18",
        },
        cpf: {
        ...
        preco:{
            ...
            customError: "O valor deve ser maior do que R$ 0",
        },
        nomeProduto: {
